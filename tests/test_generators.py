...
def test_filter_by_currency(gen: tuple[dict[str, object]]) -> Any:
...
def test_transaction_descriptions(index: int, expected: Any, gen: tuple[dict[str, object]]) -> Any:
...
@pytest.mark.parametrize(
    "start, stop, expected",
    [(0, 1, "0000 0000 0000 0000"), (9999999999999999, 9999999999999999, "9999 9999 9999 9999")],
)
